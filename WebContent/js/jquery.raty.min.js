 ...
 * 
 * @version 2.5.2 @author Washington Botelho @documentation wbotelhos.com/raty
 * 
 */
	...
	var a = {
		init : function(c) {
			return this.each(function() {
						...
						var e = b(this), g = ["number", "readOnly", "score",
								"scoreName"];
		...
		_bindClick : function() {
			...
			c.stars.on("click.raty", function(e) {
						c.score.val((c.opt.half || c.opt.precision) ? d
								.data("score") : this.alt);
						if (c.opt.click) {
		...
		_createStars : function() {
			...
			for (var c = 1; c <= this.opt.number; c++) {
				var f = a._getHint.call(this, c), d = (this.opt.score && this.opt.score >= c)
						? "starOn"
						: "starOff";
		...
		_fill : function(d) {
			...
			for (var f = 1; f <= m.stars.length; f++) {
				var g = m.stars.eq(f - 1), l = m.opt.single
						? (f == d)
						: (f <= d);
